...
# Script to build and run the https://petstore3.swagger.io/api/v3 MCP Server locally in Docker
...
IMAGE_NAME="httpspetstore3swaggerioapiv3-mcp-server"
CONTAINER_NAME="httpspetstore3swaggerioapiv3-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running https://petstore3.swagger.io/api/v3 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# https://petstore3.swagger.io/api/v3 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ https://petstore3.swagger.io/api/v3 MCP Server is running!${NC}"
echo
